...
export function EtsyShop() {
  ...
  return (
    <section id="etsy" className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="absolute top-10 left-20 w-12 h-12 bg-primary border-4 border-foreground shadow-[6px_6px_0px_0px_#000000] rotate-45 opacity-10 hover:opacity-40 hover:scale-125 hover:rotate-90 transition-all duration-500 cursor-pointer"></div>
      <div className="absolute bottom-20 right-20 w-16 h-16 bg-secondary border-4 border-foreground shadow-[8px_8px_0px_0px_#000000] -rotate-12 opacity-10 hover:opacity-40 hover:scale-125 hover:rotate-45 transition-all duration-500 cursor-pointer"></div>
      
      {/* Sewing themed floating elements */}
      <Scissors className="absolute top-32 right-1/4 w-8 h-8 text-accent opacity-20 rotate-45 hover:opacity-60 hover:scale-150 hover:rotate-180 transition-all duration-700 cursor-pointer animate-pulse" />
      <Circle className="absolute top-1/4 left-1/4 w-6 h-6 text-primary opacity-15 hover:opacity-50 hover:scale-150 transition-all duration-300 cursor-pointer animate-pulse" style={{ animationDelay: '1s' }} />
      <Minus className="absolute bottom-1/3 left-1/3 w-5 h-5 text-secondary opacity-20 hover:opacity-60 hover:scale-150 transition-all duration-300 cursor-pointer animate-pulse" style={{ animationDelay: '2s' }} />
      <Zap className="absolute top-1/2 right-10 w-4 h-4 text-accent opacity-15 hover:opacity-50 hover:scale-150 transition-all duration-300 cursor-pointer animate-pulse" style={{ animationDelay: '1.5s' }} />
      
      {/* Embroidery hoop simulation */}
      <div className="absolute top-20 right-10 w-20 h-20 border-4 border-muted-foreground rounded-full opacity-10 hover:opacity-30 hover:scale-125 hover:rotate-45 transition-all duration-500 cursor-pointer">
        ...
        <div className="mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {products.map((product, index) => (
              <Card 
                key={product.id}
                className={`bg-card text-card-foreground border-4 border-foreground shadow-[6px_6px_0px_0px_#000000] transition-all duration-300 cursor-pointer hover:shadow-[12px_12px_0px_0px_#000000] hover:-translate-x-[6px] hover:-translate-y-[6px] hover:scale-105 group ${
                  ...
                  <div className="flex justify-between items-center mb-3">
                    ...
                    <div className="flex items-center gap-1">
                      {[...Array(5)].map((_, i) => (
                        <Star 
                          key={i} 
                          className={`w-4 h-4 cursor-pointer transition-all duration-200 hover:scale-125 ${
        ...
        <div className="text-center space-y-8">
          <div className="bg-muted border-4 border-foreground p-8 shadow-[8px_8px_0px_0px_#000000] hover:shadow-[16px_16px_0px_0px_#000000] hover:-translate-x-[8px] hover:-translate-y-[8px] transition-all duration-300 rotate-1 hover:rotate-0">
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div className="text-left">
                <h3 className="text-2xl font-black uppercase tracking-tight mb-2 hover:text-primary transition-colors duration-300 cursor-pointer">
                  Готов к покупкам?
                </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div 
                key={index}
                className={`bg-card border-2 border-foreground p-4 text-center shadow-[4px_4px_0px_0px_#000000] hover:shadow-[8px_8px_0px_0px_#000000] hover:-translate-x-[4px] hover:-translate-y-[4px] transition-all duration-300 cursor-pointer hover:scale-105 ${
                  index % 2 === 0 ? 'rotate-1 hover:rotate-0' : '-rotate-1 hover:rotate-0'
                }`}
              >
