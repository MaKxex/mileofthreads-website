          ...
          <div className="space-y-8">
            <div className="relative group">
              ...
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-all duration-300">
                <div className="bg-accent text-accent-foreground px-6 py-3 border-4 border-foreground shadow-[6px_6px_0px_0px_#000000] rotate-12 font-black uppercase tracking-wide text-lg hover:rotate-0 hover:scale-110 transition-all duration-300  ">
                  mile of Threads!
                </div>
              </div>
            </div>            
